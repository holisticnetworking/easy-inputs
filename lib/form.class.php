...
class Form 
{
     ...
     *      "name" attribute, but does get used to create it. If grouping is requested,
     *      this argument will be rolled into the combined HTML name of the group.
     ...
     */
    public function input( string $name, array $attrs=[], array $args=[], array $options=[] ) 
    {
        return ( new Input( $name, $attrs, $options, $this ) )->create();
    }
