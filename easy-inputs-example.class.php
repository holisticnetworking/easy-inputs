...
class EasyInputsExample
{
    ...
    public function html5DatetimeLocal()
    {
        ...
        echo sprintf('<p>%s</p>', _('The extra formatting you see for this field is generated by the browser, 
            based on local date/time format.'));
    }
    ...
    public function html5ColorPicker()
    {
        ...
        echo sprintf('<p>%s</p>', _('Again, a browser-based color picker that converts to RGB color values. 
            No javascript, just awesome.'));
    }
    ...
    public function __construct()
    {
        ...
        add_action('admin_init', [ $this, 'registerSettings' ]);
        add_action('admin_enqueue_scripts', [&$this, 'enqueueUploader']);
    }
}
